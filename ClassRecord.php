        ...
        <div class="form-group mx-2">
            ...
            <select name="subject_id" id="subject_id" class="form-control">
                ...
                <?php while ($subject = mysqli_fetch_assoc($subjects_result)) { ?>
                    <option value="<?php echo htmlspecialchars($subject['id']); ?>" <?php if ($subject_id == $subject['id']) echo 'selected'; ?>>
        ...
        <div class="form-group mx-2">
            ...
            <select name="school_year" id="school_year" class="form-control">
                ...
                <?php while ($year = mysqli_fetch_assoc($school_years_result)) { ?>
                    <option value="<?php echo htmlspecialchars($year['school_year']); ?>" <?php if ($school_year == $year['school_year']) echo 'selected'; ?>>
